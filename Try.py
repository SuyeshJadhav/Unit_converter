...
def inter_to(result_to):
    global metre
    if result_to == 'Millimetre':
        calculate = metre * 1000

    elif result_to == 'Centimetre':
        calculate = metre * 100

    elif result_to == 'Metre':
        calculate = metre 

    elif result_to == 'Kilometre':
        calculate = metre * 0.001

    elif result_to == 'Inch':
        calculate = metre * 39.3700787

    elif result_to == 'Foot':
        calculate = metre * 3.2808399

    elif result_to == 'Yard':
        calculate = metre * 1.0936133

    elif result_to == 'Mile':
        calculate = metre * 0.00062137

    return calculate

def from_inter(result_from,result_to):
    global metre
    if result_from == 'Millimetre':
        ...
        metre = number1 * 0.0254

    elif result_from == 'Foot':
        metre = number1 * 0.3048

    elif result_from == 'Yard':
        metre = number1 * 0.9144

    elif result_from == 'Mile':
        metre = number1 * 1609.3
    
    calculate = inter_to(result_to)
    return calculate
